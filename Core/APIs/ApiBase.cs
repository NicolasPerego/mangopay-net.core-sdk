...
namespace MangoPay.SDK.Core.APIs
{
	...
	public abstract class ApiBase
	{
		...
		/// <param name="entityId">Entity identifier.</param>
		/// <returns>The DTO instance returned from API.</returns>
		protected async Task<U> CreateObject<U, T>(String idempotencyKey, MethodKey methodKey, T entity, string entityId)
			where U : EntityBase, new()
			where T : EntityPostBase
		{
			return await CreateObject<U, T>(idempotencyKey, methodKey, entity, entityId, "");
		}
		...
		/// <param name="entity">DTO instance that is going to be sent.</param>
		/// <returns>The DTO instance returned from API.</returns>
		protected async Task<U> CreateObject<U, T>(String idempotencyKey, MethodKey methodKey, T entity)
			where U : EntityBase, new()
			where T : EntityPostBase
		{
			return await CreateObject<U, T>(idempotencyKey, methodKey, entity, "");
		}
		...
		/// <param name="entityId">Entity identifier.</param>
		/// <returns>The Dto instance returned from API.</returns>
		protected async Task<T> GetObject<T>(MethodKey methodKey, string entityId)
			where T : EntityBase, new()
		{
			return await GetObject<T>(methodKey, entityId, "");
		}
		...
		protected async Task<ListPaginated<T>> GetList<T>(MethodKey methodKey, Pagination pagination, string entityId, string secondEntityId, Sort sort, Dictionary<String, String> additionalUrlParams)
			where T : EntityBase, new()
		{
			var endPoint = GetApiEndPoint(methodKey);
			endPoint.SetParameters(entityId, secondEntityId);
		...
		protected async Task<ListPaginated<T>> GetList<T>(MethodKey methodKey, Pagination pagination, Sort sort = null)
			where T : EntityBase, new()
		{
			return await GetList<T>(methodKey, pagination, "", sort);
		}
		...
		/// <param name="entity">Dto instance that is going to be sent.</param>
		/// <returns>The Dto instance returned from API.</returns>
		protected async Task<U> UpdateObject<U, T>(MethodKey methodKey, T entity)
			where U : EntityBase, new()
			where T : EntityPutBase
		{
			return await UpdateObject<U, T>(methodKey, entity, "");
		}
		...
		/// <param name="entityId">Entity identifier.</param>
		/// <returns></returns>
		protected async Task<U> UpdateObject<U, T>(MethodKey methodKey, T entity, string entityId)
			where U : EntityBase, new()
			where T : EntityPutBase
		{
			return await UpdateObject<U, T>(methodKey, entity, entityId, "");
		}
		...
		/// <param name="secondEntityId">Second entity identifier.</param>
		/// <returns>The Dto instance returned from API.</returns>
		protected async Task<U> UpdateObject<U, T>(MethodKey methodKey, T entity, string entityId, string secondEntityId)
			where U : EntityBase, new()
			where T : EntityPutBase
		{
			var endPoint = GetApiEndPoint(methodKey);
