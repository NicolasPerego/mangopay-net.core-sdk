...
namespace MangoPay.SDK.Core.APIs
{
    ...
    public class ApiReports : ApiBase
    {
		...
		public async Task<ListPaginated<ReportRequestDTO>> GetAll(Pagination pagination, FilterReportsList filters = null, Sort sort = null)
        {
			...
			ListPaginated<ReportRequestTransportDTO> resultTransport = await this.GetList<ReportRequestTransportDTO>(MethodKey.ReportGetAll, pagination, sort, filters.GetValues());
